...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--ego_base_pos", default="0.0,-0.20,0.0")
    p.add_argument("--ego_base_orn", default="0.0,0.0,0.0,1.0")
    p.add_argument("--obs_base_pos", default="0.30,0.20,0.0")
    p.add_argument("--obs_base_orn", default="0.0,0.0,0.0,1.0")
    ...
    p.add_argument("--d_safe", type=float, default=0.28)
